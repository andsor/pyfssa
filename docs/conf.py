...
for key, value in [
    ...
    ('Source (GitHub)', 'http://github.com/andsor/pyfssa'),
    ('Issues (GitHub)', 'http://github.com/andsor/pyfssa/issues'),
    ('Bibliography (CiteULike)', 'http://www.citeulike.org/group/19073'),
]:
